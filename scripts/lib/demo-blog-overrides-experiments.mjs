...
export const DEMO_BLOG_OVERRIDES_EXPERIMENTS = {
  ...
  'webgpu-particles': {
    ...
    coverNote: 'The cover shows the fire/smoke column over the grid ground.',
    whyBullets: [
    ...
    whyUses: 'forge / launch moods, camp and industrial sketches, and lightweight hero loops.',
    beginner:
      'Fire and smoke here are many small images (sprites) that fade and swirl over time. Additive blending makes flames feel bright; smoke uses softer textures. Together they sell heat without simulating real combustion.',
    glossary: [
    ...
    trySteps: [
      ...
      'Note the ground grid for scale and contact',
    ],
    requirements: [
    ...
    viewA: { file: 'view-a.jpg', caption: 'Hero column — additive fire with smoke lift' },
    viewB: { file: 'view-b.jpg', caption: 'Side read — sprite layering over the grid ground' },
    alsoCan: [
  ...
  spout: {
    ...
    demoLabel: 'Spout',
    hook: 'A chrome pipe pouring raymarched water — refraction, transparency, and reflections in a self-hosted WebGL2 port of P_Malin’s classic Shadertoy. Drag to orbit the sculpture of fluid.',
    coverNote: 'The cover shows the pipe spout with refractive water catching the environment.',
    whyBullets: [
    ...
    whyUses: 'shader craft demos, liquid branding mood boards, and teaching raymarching look-dev.',
    beginner:
      'The water is not a filmed splash. The GPU walks rays through a mathematical shape until it hits “water” or “metal,” then bends the view like a lens. That is why the pipe and fluid can look so clean from every angle.',
    glossary: [
