...
${o.heroRecordingSlug ? `    heroRecordingSlug: ${JSON.stringify(o.heroRecordingSlug)},\n` : ''}${o.heroVideoFile ? `    heroVideoFile: ${JSON.stringify(o.heroVideoFile)},\n` : ''}${o.heroVideoCaption ? `    heroVideoCaption: ${JSON.stringify(o.heroVideoCaption)},\n` : ''}    hook: \`${esc(o.hook)}\`,
...
import { buildDemoBlogPostWithTranslations } from './demoPostBuilder'
import type { BlogPost } from '../types'
import { deDemoBlogPosts } from './locales/de'
import { esDemoBlogPosts } from './locales/es'
import { frDemoBlogPosts } from './locales/fr'
import { itDemoBlogPosts } from './locales/it'
import { nlDemoBlogPosts } from './locales/nl'

const DEMO_BLOG_LOCALE_PACKS = {
  de: deDemoBlogPosts,
  fr: frDemoBlogPosts,
  nl: nlDemoBlogPosts,
  it: itDemoBlogPosts,
...
export const GENERATED_DEMO_BLOG_POSTS: BlogPost[] = DEMO_POST_SPECS.map((spec) =>
  buildDemoBlogPostWithTranslations(spec, DEMO_BLOG_LOCALE_PACKS),
)
`
