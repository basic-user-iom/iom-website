const NAMED_SCOPES = {
  ...
  'building-viewer': [
    ...
    'public/models/icm-golden-ext/',
    'public/models/icm-golden-int/',
    'public/models/icm-anim-2025/model-web.glb',
    'public/models/icm-anim-2025/model-web.glb.provenance.json',
    'public/models/icm-anim-2025/model-quest.glb',
    'public/models/icm-anim-2025/model-quest.glb.provenance.json',
    'public/models/icm-anim-2025/blender-report-v2.json',
    'public/models/icm-anim-2025/surface-audit-model-web-v2.json',
    'public/models/icm-anim-2025/surface-audit-model-quest-v2.json',
