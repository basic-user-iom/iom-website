...
export const Footer = memo(function Footer() {
  ...
  const onHomeHash = (id: string) => (event: MouseEvent<HTMLAnchorElement>) => {
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-links">
        <a href={href('/#about')} onClick={onHomeHash('about')}>{t('footer.about')}</a>
        <a href={href('/#engage-iom')} onClick={onHomeHash('engage-iom')}>{t('footer.costs')}</a>
        <a href={href('/#rfo')} onClick={onHomeHash('rfo')}>{t('footer.methodology')}</a>
        <a href={href('/#clients')} onClick={onHomeHash('clients')}>{t('footer.clients')}</a>
        <a href={href('/#360')} onClick={onHomeHash('360')}>{t('footer.caseStudies')}</a>
        <a href={href('/blog')}>{t('footer.blog')}</a>
        <a href={href('/#contact')} onClick={onHomeHash('contact')}>{t('footer.contact')}</a>
