...
const en: Dict = {
  ...
  'ideas.boardHint':
    'Drag the left handle to move · siblings sit side by side · lines show parent → child',
...
const sr: Dict = {
  ...
  'ideas.boardHint':
    'Prevucite levom ručicom · sibling čvorovi su jedan pored drugog · linije pokazuju roditelj → dete',
