...
const en: Dict = {
  ...
  'recorder.voice.aiHint':
    'AI morph runs after stop when ELEVENLABS_API_KEY is set. Voices load from your ElevenLabs account — add more there and they appear here.',
  ...
  'recorder.appearance.avatar': 'Avatar',
...
const sr: Dict = {
  ...
  'recorder.voice.aiHint':
    'AI morf radi posle zaustavljanja kada je ELEVENLABS_API_KEY podešen. Glasovi se učitavaju sa ElevenLabs naloga — dodajte nove tamo i pojaviće se ovde.',
