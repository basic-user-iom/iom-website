...
const en: Dict = {
  ...
  'login.mfaBlurb': 'Enter the 6-digit code from your authenticator app.',
  ...
  'mfa.intro':
    'Staff accounts require an authenticator app (Google Authenticator, 1Password, Authy, etc.) before using the CRM.',
  'mfa.start': 'Show QR code',
  'mfa.starting': 'Preparing…',
  'mfa.startFailed': 'Could not start MFA enrollment. Try again.',
  'mfa.scanHint': 'Scan this QR code with your authenticator app, then enter the 6-digit code.',
  'mfa.qrAlt': 'Authenticator QR code',
  'mfa.showSecret': 'Show secret key instead',
  'mfa.hideSecret': 'Hide secret key',
  'mfa.confirm': 'Confirm and continue',
  'mfa.codeFailed': 'That code did not work. Check the app clock and try again.',
  ...
  'nda.title': 'NDA',
  'nda.blurb':
    'Fill signatory and jurisdiction, then copy or download a mutual NDA for this lead before technical discussions.',
  'nda.disclaimer':
    'Staff template only — not legal advice. Confirm jurisdiction and have counsel review before sending.',
  'nda.signatory': 'IOM authorized signatory',
  'nda.signatoryPh': 'Legal name of the person signing for IOM',
  'nda.jurisdiction': 'Governing jurisdiction',
  'nda.jurisdictionPh': 'e.g. the Netherlands, Serbia, England and Wales',
  'nda.copy': 'Copy text',
  'nda.copied': 'Copied',
  'nda.copyFailed': 'Could not copy NDA text.',
  'nda.download': 'Download .txt',
  'nda.showPreview': 'Show preview',
  'nda.hidePreview': 'Hide preview',
  'nda.statusNotSent': 'Not sent',
  'nda.statusSent': 'Sent',
  'nda.statusSigned': 'Signed',
  'nda.markNotSent': 'Mark not sent',
  'nda.markSent': 'Mark sent',
  'nda.markSigned': 'Mark signed',
  'nda.statusFailed': 'Could not update NDA status.',
  'nda.updated': 'Last NDA update',
  'nda.activitySent': 'NDA marked sent',
  'nda.activitySigned': 'NDA marked signed',
  'nda.activityReset': 'NDA status reset',
  'nda.activityBody': 'Mutual NDA for {company} (CRM template).',
  ...
  'projectCosts.copyLink': 'Copy link',
  'projectCosts.copied': 'Copied',
  'projectCosts.openTab': 'Open in new tab',
  'projectCosts.iframeTitle': 'Project costs & timelines',
  ...
  'clients.kicker': 'Tenancy',
  'clients.title': 'Client accounts',
  'clients.intro':
    'Create org accounts, link Auth users by email, then share projects below (or under Projects).',
  'clients.namePlaceholder': 'Account name',
  'clients.linkLead': 'Link lead (optional)',
  'clients.linkLeadNone': 'No linked lead',
  'clients.create': 'Create account',
  'clients.empty': 'No client accounts yet.',
  'clients.unnamed': 'Untitled account',
  ...
  'clients.projects': 'Shared projects',
  'clients.projectsHint':
    'Attach projects so members of this account can see them in the client portal when Visible is on.',
  'clients.addProject': 'Add project',
  'clients.addProjectNone': 'Select a project…',
  'clients.projectLinkedOther': 'linked elsewhere',
  'clients.noProjects': 'No projects linked to this account yet.',
  'clients.projectVisible': 'Visible to client',
  'clients.projectHidden': 'Hidden from client',
  'clients.showProject': 'Show',
  'clients.hideProject': 'Hide',
  'clients.unlinkProject': 'Remove',
  'clients.unlinkProjectConfirm':
    'Unlink this project from the client account? It stays in Projects for staff.',
  'clients.errorProjects': 'Could not update shared projects.',
  ...
  'clients.errorUpdate': 'Could not update account.',
  ...
  'access.deniedBody':
    'This account is signed in but is not staff and is not linked to a client account. Contact IOM if you need access.',
  ...
  'ideas.addFreeNote': 'Add free note',
  'ideas.connect': 'Connect',
  'ideas.connectCancel': 'Cancel connect',
  'ideas.connectPickTarget': 'Connect “{title}”: click another note',
  'ideas.connectChooseRelation': 'How should “{title}” attach?',
  'ideas.connectPanelTitle': 'Link “{from}” → “{to}”',
  'ideas.connectAsChild': 'Make child of target',
  'ideas.connectAsSibling': 'Make sibling of target',
  'ideas.connectAsParent': 'Make parent of target',
  'ideas.detachNote': 'Detach (free note)',
  'ideas.connectCycle': 'That link would create a loop in the tree.',
  'ideas.connectSame': 'Pick a different note to connect to.',
  'ideas.connectFailed': 'Could not connect notes.',
  ...
  'ideas.richSelectNode': 'Select a node, then Edit / Add rich note to change text, tables, and images.',
  'ideas.richEditHint': 'Click Edit rich note (or the preview below the node) to change text and images.',
  'ideas.richKicker': 'Selected node',
  'ideas.richTitle': 'Rich note — tables & images',
  'ideas.richEditTitle': 'Edit rich note',
  'ideas.richEdit': 'Edit rich note',
  'ideas.richEditShort': 'Edit',
  'ideas.richViewLarger': 'View note',
  'ideas.richAdd': 'Add rich note',
  'ideas.richBlurb':
  ...
  'ideas.richSaveClose': 'Save & close',
  'ideas.richEditorLabel': 'Text / markdown',
  'ideas.richImagesLabel': 'Images in this note',
  'ideas.richImageCaption': 'Caption',
  'ideas.richImageReplace': 'Replace',
  'ideas.richImageRemove': 'Remove',
  ...
  'ideas.boardHint':
    'Add free notes, then Connect as child / sibling / parent · drag the left handle to move',
  'ideas.boardResetLayout': 'Reset layout',
  'ideas.boardDrag': 'Drag to move',
  'ideas.boardRename': 'Rename',
  'ideas.boardRenameHint': 'Double-click to rename',
  ...
  'outreach.pingOkIdle':
    'Server pinged — {checked} armed schedule(s), none due yet.',
  'outreach.pingOkSent':
    'Server pinged — sent {sent}, failed {failed} (due {due}). Each lead is handled separately.',
  'outreach.pingDemoOk': 'Demo pinged — due schedules processed locally (no SMTP).',
  'outreach.pingFailed': 'Schedule saved, but server ping failed: {error}',
  'outreach.pingFailedOnly': 'Server ping failed: {error}',
  ...
  'guide.demos1':
    'ICM: https://iobjectm.com/demo/icm · ICM - viewer: https://iobjectm.com/demos/building-viewer/ · EVLY: https://iobjectm.com/demo/evly/ · Kelly Kettle: https://iobjectm.com/demos/kelly-kettle/ · Precision object: https://iobjectm.com/demos/precision-object/ · Automotive Studio: https://iobjectm.com/demos/automotive-studio/ · Dukta: https://iobjectm.com/demos/dukta/ · Superbright rock: https://iobjectm.com/demos/floating-stone/ (passwords in the cards)',
  'guide.demos2':
...
const sr: Dict = {
  ...
  'login.mfaBlurb': 'Unesite 6-cifreni kod iz autentikator aplikacije.',
  'login.mfaCode': 'Kod za autentifikaciju',
  'login.mfaSubmit': 'Potvrdi',
  ...
  'mfa.intro':
    'Nalozi tima zahtevaju autentikator aplikaciju (Google Authenticator, 1Password, Authy itd.) pre korišćenja CRM-a.',
  'mfa.start': 'Prikaži QR kod',
  'mfa.starting': 'Priprema…',
  'mfa.startFailed': 'Nije moguće pokrenuti MFA. Pokušajte ponovo.',
  'mfa.scanHint': 'Skenirajte QR kod autentikator aplikacijom, zatim unesite 6-cifreni kod.',
  'mfa.qrAlt': 'QR kod za autentikator',
  'mfa.showSecret': 'Prikaži tajni ključ',
  'mfa.hideSecret': 'Sakrij tajni ključ',
  'mfa.confirm': 'Potvrdi i nastavi',
  'mfa.codeFailed': 'Kod nije ispravan. Proverite sat na telefonu i pokušajte ponovo.',
  ...
  'nda.title': 'NDA',
  'nda.blurb':
    'Unesite potpisnika i nadležnost, pa kopirajte ili preuzmite međusobni NDA za ovaj lead pre tehničkih razgovora.',
  'nda.disclaimer':
    'Samo interni šablon — nije pravni savet. Potvrdite nadležnost i neka advokat pregleda pre slanja.',
  'nda.signatory': 'Ovlašćeni potpisnik IOM-a',
  'nda.signatoryPh': 'Puno ime osobe koja potpisuje za IOM',
  'nda.jurisdiction': 'Nadležnost (pravo)',
  'nda.jurisdictionPh': 'npr. Holandija, Srbija, Engleska i Vels',
  'nda.copy': 'Kopiraj tekst',
  'nda.copied': 'Kopirano',
  'nda.copyFailed': 'Kopiranje NDA teksta nije uspelo.',
  'nda.download': 'Preuzmi .txt',
  'nda.showPreview': 'Prikaži pregled',
  'nda.hidePreview': 'Sakrij pregled',
  'nda.statusNotSent': 'Nije poslato',
  'nda.statusSent': 'Poslato',
  'nda.statusSigned': 'Potpisano',
  'nda.markNotSent': 'Označi kao nije poslato',
  'nda.markSent': 'Označi kao poslato',
  'nda.markSigned': 'Označi kao potpisano',
  'nda.statusFailed': 'Ažuriranje statusa NDA nije uspelo.',
  'nda.updated': 'Poslednje ažuriranje NDA',
  'nda.activitySent': 'NDA označen kao poslat',
  'nda.activitySigned': 'NDA označen kao potpisan',
  'nda.activityReset': 'Status NDA resetovan',
  'nda.activityBody': 'Međusobni NDA za {company} (CRM šablon).',
  ...
  'projectCosts.copyLink': 'Kopiraj link',
  'projectCosts.copied': 'Kopirano',
  'projectCosts.openTab': 'Otvori u novom tabu',
  'projectCosts.iframeTitle': 'Troškovi i rokovi projekta',
  ...
  'clients.kicker': 'Pristup',
  'clients.title': 'Klijentski nalozi',
  'clients.intro':
    'Kreirajte organizacije, povežite Auth korisnike emailom, zatim delite projekte ispod (ili u Projektima).',
  'clients.namePlaceholder': 'Naziv naloga',
  'clients.linkLead': 'Poveži lead (opciono)',
  'clients.linkLeadNone': 'Bez povezanog leada',
  'clients.create': 'Kreiraj nalog',
  'clients.empty': 'Još nema klijentskih naloga.',
  'clients.unnamed': 'Nalog bez naziva',
  'clients.active': 'Aktivan',
  ...
  'clients.projects': 'Deljeni projekti',
  'clients.projectsHint':
    'Povežite projekte da članovi ovog naloga vide portal kada je Vidljivo uključeno.',
  'clients.addProject': 'Dodaj projekat',
  'clients.addProjectNone': 'Izaberite projekat…',
  'clients.projectLinkedOther': 'povezan drugde',
  'clients.noProjects': 'Još nema projekata na ovom nalogu.',
  'clients.projectVisible': 'Vidljivo klijentu',
  'clients.projectHidden': 'Sakriveno od klijenta',
  'clients.showProject': 'Prikaži',
  'clients.hideProject': 'Sakrij',
  'clients.unlinkProject': 'Ukloni',
  'clients.unlinkProjectConfirm':
    'Ukloniti projekat sa klijentskog naloga? Ostaje u Projektima za staff.',
  'clients.errorProjects': 'Nije moguće ažurirati deljene projekte.',
  ...
  'clients.errorUpdate': 'Nije moguće ažurirati nalog.',
  ...
  'access.deniedBody':
    'Nalog je prijavljen, ali nije staff i nije povezan sa klijentskim nalogom. Kontaktirajte IOM za pristup.',
  ...
  'ideas.addFreeNote': 'Dodaj slobodnu belešku',
  'ideas.connect': 'Poveži',
  'ideas.connectCancel': 'Otkaži povezivanje',
  'ideas.connectPickTarget': 'Poveži „{title}”: kliknite drugu belešku',
  'ideas.connectChooseRelation': 'Kako da se „{title}” poveže?',
  'ideas.connectPanelTitle': 'Veza „{from}” → „{to}”',
  'ideas.connectAsChild': 'Učini detetom cilja',
  'ideas.connectAsSibling': 'Učini bratom/sestrom cilja',
  'ideas.connectAsParent': 'Učini roditeljem cilja',
  'ideas.detachNote': 'Odvoji (slobodna beleška)',
  'ideas.connectCycle': 'Ta veza bi napravila petlju u stablu.',
  'ideas.connectSame': 'Izaberite drugu belešku za povezivanje.',
  'ideas.connectFailed': 'Povezivanje beleški nije uspelo.',
  ...
  'ideas.richSelectNode': 'Izaberite čvor, zatim Izmeni / Dodaj rich note da menjate tekst, tabele i slike.',
  'ideas.richEditHint': 'Kliknite Izmeni rich note (ili pregled ispod čvora) da menjate tekst i slike.',
  'ideas.richKicker': 'Izabrani čvor',
  'ideas.richTitle': 'Rich note — tabele i slike',
  'ideas.richEditTitle': 'Izmena rich note',
  'ideas.richEdit': 'Izmeni rich note',
  'ideas.richEditShort': 'Izmeni',
  'ideas.richViewLarger': 'Pogledaj belešku',
  'ideas.richAdd': 'Dodaj rich note',
  'ideas.richBlurb':
  ...
  'ideas.richSaveClose': 'Sačuvaj i zatvori',
  'ideas.richEditorLabel': 'Tekst / markdown',
  'ideas.richImagesLabel': 'Slike u ovoj belešci',
  'ideas.richImageCaption': 'Opis',
  'ideas.richImageReplace': 'Zameni',
  'ideas.richImageRemove': 'Ukloni',
  ...
  'ideas.boardHint':
    'Dodajte slobodne beleške, zatim Poveži kao dete / sibling / roditelj · prevucite levom ručicom',
  'ideas.boardResetLayout': 'Resetuj raspored',
  'ideas.boardDrag': 'Prevuci za pomeranje',
  'ideas.boardRename': 'Preimenuj',
  'ideas.boardRenameHint': 'Dvoklik za preimenovanje',
  ...
  'outreach.pingOkIdle':
    'Server pingovan — {checked} zakazano, nijedno još nije dospelo.',
  'outreach.pingOkSent':
    'Server pingovan — poslato {sent}, neuspelo {failed} (dospelo {due}). Svaki lead se obrađuje posebno.',
  'outreach.pingDemoOk': 'Demo ping — dospeli rasporedi obrađeni lokalno (bez SMTP).',
  'outreach.pingFailed': 'Raspored sačuvan, ali ping servera nije uspeo: {error}',
  'outreach.pingFailedOnly': 'Ping servera nije uspeo: {error}',
  ...
  'guide.demos1':
    'ICM: https://iobjectm.com/demo/icm · ICM - viewer: https://iobjectm.com/demos/building-viewer/ · EVLY: https://iobjectm.com/demo/evly/ · Kelly Kettle: https://iobjectm.com/demos/kelly-kettle/ · Precision object: https://iobjectm.com/demos/precision-object/ · Automotive Studio: https://iobjectm.com/demos/automotive-studio/ · Dukta: https://iobjectm.com/demos/dukta/ · Superbright rock: https://iobjectm.com/demos/floating-stone/ (lozinke su na karticama)',
  'guide.demos2':
