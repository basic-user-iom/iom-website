...
const en: Dict = {
  ...
  'seo.topSourcesNote': 'UTM campaigns + search/social/referral channels.',
  'seo.noSources': 'No acquisition data yet.',
  'seo.topKeywords': 'Keywords',
  'seo.topKeywordsNote':
    'From utm_term or search referrers. Google organic keywords are not passed to websites — use Search Console for those.',
  'seo.noKeywords': 'No keywords captured yet. Add ?utm_term=… on campaign links.',
  'seo.topLinks': 'Links opened',
  'seo.topLinksNote': 'Clicks on links from your pages (internal + outbound).',
  'seo.noLinks': 'No link clicks recorded yet.',
  'seo.devices': 'Devices',
...
const sr: Dict = {
  ...
  'seo.topSourcesNote': 'UTM kampanje + pretraga / društvene mreže / referral.',
  'seo.noSources': 'Još nema podataka o akviziciji.',
  'seo.topKeywords': 'Ključne reči',
  'seo.topKeywordsNote':
    'Iz utm_term ili search referrera. Google organske ključne reči ne šalje sajtovima — za to koristite Search Console.',
  'seo.noKeywords': 'Još nema ključnih reči. Dodajte ?utm_term=… na kampanjske linkove.',
  'seo.topLinks': 'Otvoreni linkovi',
  'seo.topLinksNote': 'Klikovi na linkove sa vaših stranica (interni + spoljni).',
  'seo.noLinks': 'Još nema zabeleženih klikova na linkove.',
  'seo.devices': 'Uređaji',
