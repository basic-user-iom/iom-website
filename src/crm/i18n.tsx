...
const en: Dict = {
  ...
  'clients.intro':
    'Create org accounts, link Auth users by email, then mark projects visible under Projects.',
...
const sr: Dict = {
  ...
  'clients.intro':
    'Kreirajte organizacije, povežite Auth korisnike emailom, zatim u Projektima označite vidljivost.',
