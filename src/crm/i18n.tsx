...
const en: Dict = {
  ...
  'guide.demos1':
    'ICM: https://iobjectm.com/demo/icm · EVLY: https://iobjectm.com/demo/evly/ (passwords in the cards)',
  'guide.demos2':
...
const sr: Dict = {
  ...
  'guide.demos1':
    'ICM: https://iobjectm.com/demo/icm · EVLY: https://iobjectm.com/demo/evly/ (lozinke su na karticama)',
  'guide.demos2':
