...
const en: Dict = {
  ...
  'blog.importCatalogDone': 'Catalog imported',
  'blog.importing': 'Importing…',
  'blog.importResult': 'Imported {created} posts ({skipped} already present).',
...
const sr: Dict = {
  ...
  'blog.importCatalogDone': 'Katalog uvezen',
  'blog.importing': 'Uvoz…',
  'blog.importResult': 'Uvezeno {created} članaka ({skipped} već postoji).',
