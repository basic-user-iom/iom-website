...
export const frUi: Dict = {
  ...
  'hero.hudPoster': 'POSTER · PRÊT',
  'hero.start': 'Lancer la scène live',
  'hero.startHint': 'WebGL se charge après un appui',
  'hero.startAria': 'Lancer la scène WebGL live du hero',
  'hero.scroll': 'Défiler',

  'home.engage.title': 'Travailler avec IOM',
  'home.engage.lead':
  ...
  'home.engage.outcomes':
    'Assets 3D exigeants · applications temps réel · visualisation technique · expériences produit interactives · présentations spatiales',
  ...
  'home.engage.proofLabel': 'Travaux pertinents',
  'home.engage.trustAria': 'Notes de collaboration',
  'home.engage.trust.whiteLabel': 'Compatible marque blanche',
  'home.engage.trust.nda': 'Compatible NDA',
  'home.engage.trust.remote': 'Collaboration à distance',
  'home.engage.trust.project': 'Par projet',
  'home.engage.proof.viewer': 'Outils de revue technique, traitement de données 3D et livraison navigateur',
  'home.engage.proof.ssr': 'Exploration temps réel, import, inspection et expérimentation technique',
  'home.engage.proof.witness': 'Storytelling 360° / spatial et expérience culturelle',
  'home.engage.proof.miab': 'Une interaction créative complète dans le navigateur',
  ...
  'rfo.method':
    'Processus client aligné sur Research, Form et Output — ouvrir chaque étape pour le rôle de Raven, Fox et Octopus.',
  'rfo.phaseMore': 'Plus d’infos',
  'rfo.phaseLess': 'Moins',
  'rfo.phaseLead': '{who} · {stage}',
  'rfo.phaseOutput.title': 'Production & livraison',
  'rfo.phase1.title': 'Discovery & briefing',
  'rfo.phase1.text':
    'Aligner objectifs, contraintes et critères de succès. Signer des NDA si besoin, rassembler les références via transfert chiffré ou partage sécurisé, et définir le cadre technique avant de construire.',
  ...
  'rfo.phase3.text':
    'Construire les environnements immersifs, optimiser les assets, régler lumière et motion, et câbler l’UI pour que le travail reste reviewable sur un staging non indexé tout au long du projet.',
  'rfo.phase4.title': 'Livraison & QA',
  'rfo.phase4.text':
    'Contrôles multi-navigateurs et mobile, hébergement et CDN, vitesse de chargement, validation client claire, puis transfert avec un court support post-lancement.',
  'rfo.close':
  ...
  'contact.secure':
    'Pour les opérations haute sécurité, des portails clients sécurisés et des canaux chiffrés (Signal / ProtonMail) sont disponibles sur demande.',
  ...
  'footer.entity':
    'IOM est une marque de studio indépendante. Les modalités de contrat et de facturation sont confirmées de façon transparente pour chaque mission.',
  ...
  'seo.homeDescription':
    'IOM est un studio indépendant de technologies créatives qui propose du 3D temps réel, des expériences web interactives, de la production 3D technique et une capacité de production évolutive pour studios, marques et équipes projet.',
  'seo.projectCostsTitle': 'Coûts de projet & capacité de production — IOM',
  ...
  'seo.caseMiabTitle': 'IOM — Étude de cas Message in a Bottle',
  'seo.caseMiabDescription':
    'Du brief à la mer ouverte : comment IOM construit un souvenir WebGPU — bouteille, parchemin, océan et démo navigateur partageable.',
  'seo.caseCursorTitle': 'IOM — Étude de cas curseur personnalisé labellisé',
  'seo.caseCursorDescription':
    'Du brief au lab : comment IOM conçoit un pointeur contextuel — modes en markup, motion tip + anneau, et un lab labellisé partageable.',
