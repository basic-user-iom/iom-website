...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'panorama-suite',
    title: '360° Panorama Suite',
    section: '360',
    tags: ['equirectangular', 'ktx2', 'hdr'],
    description:
      'Standalone panorama viewer supporting KTX2 FastHDR, EXR, HDR, and standard formats — drag-and-drop or URL loading with smooth orbit navigation.',
    year: '2025',
    archiveId: 'OBJ-0056',
    availableAt: '2026-07-12T00:00:00+02:00',
  },
  {
    id: 'atelier-interior',
    title: 'Atelier Interior',
    section: '360',
    tags: ['architecture', 'virtual tour'],
    description:
      'Sample architectural walkthrough — multi-room 360 capture with hotspot navigation and material-accurate lighting presets.',
    year: '2024',
    archiveId: 'OBJ-0061',
    availableAt: '2026-07-12T00:00:00+02:00',
  },
  ...
  {
    id: 'shader-archive',
    title: 'Shader Archive',
    section: '3d',
    tags: ['glsl', 'procedural'],
    description:
      'Collection of real-time shader studies — atmospheric scattering, water caustics, and post-processing stacks.',
    year: '2025',
    availableAt: '2026-07-12T00:00:00+02:00',
    archiveId: 'OBJ-0101',
  },
  {
    ...
    tags: ['pipeline', 'gltf'],
    description:
      'Modular asset pipeline for cataloging, versioning, and previewing 3D objects across web export targets.',
    year: '2025',
    availableAt: '2026-07-12T00:00:00+02:00',
    archiveId: 'OBJ-0108',
  },
  {
    ...
    posterUrl: '/assets/posters/ocean.jpg',
    mobilePosterUrl: '/assets/posters/ocean.jpg',
  ...
  },
  {
    ...
    section: 'experiments',
    tags: ['webgpu', 'lighting', 'volume', 'rectarea', 'three.js'],
    description:
      'WebGPU volumetric fog lit by rotating rect area lights — ray-marched noise volume with depth occlusion, gaussian denoise, and tunable fog intensity via a post-processing pass.',
    year: '2026',
  ...
  {
    id: 'web-export-kit',
    title: 'Web Export Kit',
    section: 'software',
    tags: ['embed', 'zip', 'presentation'],
    description:
      'Export self-contained web presentations with camera views, transitions, compressed textures, and hotspot panels.',
    year: '2025',
    archiveId: 'OBJ-0119',
    availableAt: '2026-07-12T00:00:00+02:00',
  },
