...
![Where to click — Camera views (left), Volumetric Lighting and Objects (right)](/assets/blog/volume-lighting/ui.jpg)
...
![Through the beams — looking past the rect-area panels into the fog volume](/assets/blog/volume-lighting/beams.jpg)

![Low side profile — metallic body, floor shadows, and volumetric haze](/assets/blog/volume-lighting/profile.jpg)
...
Browse more realtime work in [3D](/#3d) and [Experiments](/#experiments), or [contact us](/#contact) if you want volumetric lighting or WebGPU product viz scoped for a client pitch.`,
  cover_image_url: '/assets/blog/volume-lighting/cover.jpg',
  status: 'published',
