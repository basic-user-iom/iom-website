...
- The Sun combines its procedural animated photosphere/corona with one fixed 2048-pixel NASA SDO/HMI continuum observation from 2025-12-26. The observation is projected only on its valid body-local hemisphere and feathers into the procedural far side; it is neither live imagery nor a fabricated global map.
