...
The machine-readable record at [`public/assets/source-manifest.json`](./public/assets/source-manifest.json) is authoritative for all 15 Phase 4/5 local paths, byte lengths, dimensions, SHA-256 digests, encoded/runtime color handling, source-raster identities, transformations, and channel semantics.
...
- Phase 5 gives Jupiter, Saturn, Uranus, and Neptune dedicated project-authored giant-planet shaders driven by the sourced catalog above. Jupiter adds the Hubble OPAL 2025a visual foundation; Saturn, Uranus, and Neptune remain procedurally colored. Ring rendering, modeled storm motion, procedural atmosphere flow, shadow approximations, and all display effects remain project implementations.
